...
import msprime #similuation library
...
demography.add_population_parameters_change(population="A", time=1000, initial_size=10_000) #time is equal to the number of generation beckward


ts = msprime.sim_ancestry( #simulate a coalescence tree
    samples=10,
...
# we can add mutations, we superimpose mutations
